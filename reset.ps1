...
$TempFile = Join-Path $env:TEMP 'reset-codex-config-windows.ps1'
$ApiUrl = "https://api.github.com/repos/$Repo/contents/scripts/reset-codex-config-windows.ps1?ref=$Ref"
